...
public class BOFEuriborFetcher
{
    ...
    private NavigableSet<InterestRateEntry>
        durationComparingInterestRateEntrySet
        (InterestRateEntry... initialEntries)
    {
        return durationComparingInterestRateEntrySet
            (Arrays.asList(initialEntries));
    }
    private NavigableSet<InterestRateEntry>
        durationComparingInterestRateEntrySet
        (Collection<InterestRateEntry> initialEntries)
    {
    ...
    private java.util.stream.Collector
        <InterestRateEntry,?,NavigableSet<InterestRateEntry>>
        toSetByDuration()
    {
        return
            Collectors.
            collectingAndThen(Collectors.toList(),
                              list ->
                              durationComparingInterestRateEntrySet(list)
                              );
    }
    
    public NavigableMap<Date, NavigableSet<InterestRateEntry>>
